/**
 * This is incase we can't find a way to package with Jon Snow in mvn
 */
import com.johnsnowlabs.nlp.base._
import com.johnsnowlabs.nlp.annotator._
import org.apache.spark.ml.Pipeline
// Read in data
val businessReviews = spark.read.option("header", "true").option("delimiter", ",").option("multiline", "true").csv("/grouped-reviews/business/business_reviews.csv")
...
// Write out results
dfToWrite.write.format("csv").option("header", "true").option("multiline", "true").save("/processed-data/business/")